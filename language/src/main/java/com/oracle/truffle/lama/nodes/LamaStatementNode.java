...
/**
 * The base class of all Truffle nodes for Lama. All nodes (even expressions) can be used as
 * statements, i.e., without returning a value. The {@link VirtualFrame} provides access to the
 * local variables.
 */
@NodeInfo(language = "Lama", description = "The abstract base node for all Lama statements")
@GenerateWrapper
